...
#                       },
#                   }
det_banks_data = {0: {'A': [(x_n(1), y_n(tube_dims - tube_dim_1 + 1), z_n(tube_dims)),
                            (x_n(1), y_n(tube_dims), z_n(tube_dims - tube_dim_1 + 1)),
                            (x_n(1), y_n(1), z_n(tube_dim_1)),
                            (x_n(1), y_n(tube_dim_1), z_n(1))],
                      'B': [(x_n(STRAW_RESOLUTION), y_n(tube_dims - tube_dim_1 + 1), z_n(tube_dims)),
                            (x_n(STRAW_RESOLUTION), y_n(tube_dims), z_n(tube_dims - tube_dim_1 + 1)),
