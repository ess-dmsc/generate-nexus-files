...
def render(template_dir, template_file_name):
    ...
    #     .rotate("axis6", x=0)
    # )
    # Detector positioning from NXlog (workaround constructor offset issue using extra transformations):
    # (
    #     detector_panel_0
    ...
    # )
    # Detector positioning from NXlog (using proper offsets):
    (
        detector_panel_0
        .translate_from_nxlog("stageZ", [0,0,1], "f144", "nmx_robot", "NMX:Robot0:stageZ", units="m", offset=[0.8, -0.7, 0.6], offset_units="m")
        .rotate_from_nxlog("axis1", [0,1,0], "f144", "nmx_robot", "NMX:Robot0:axis1", units="m", offset=[0, 0.1, 0], offset_units="m")
        .rotate_from_nxlog("axis2", [0,0,1], "f144", "nmx_robot", "NMX:Robot0:axis2", units="m", offset=[-0.22, 0, 0], offset_units="m")
        .rotate_from_nxlog("axis3", [0,0,1], "f144", "nmx_robot", "NMX:Robot0:axis3", units="m", offset=[0, 0.4, 0], offset_units="m")
        .rotate_from_nxlog("axis4", [1,0,0], "f144", "nmx_robot", "NMX:Robot0:axis4", units="m", offset=[-0.05, 0.12, 0.06], offset_units="m")
        .rotate_from_nxlog("axis5", [0,0,1], "f144", "nmx_robot", "NMX:Robot0:axis5", units="m", offset=[-0.3, 0, 0], offset_units="m")
        .rotate_from_nxlog("axis6", [1,0,0], "f144", "nmx_robot", "NMX:Robot0:axis6", units="m", offset=[-0.15, 0, 0], offset_units="m")
        .rotate("orientation", y=-90)
    )
    ...
    (
        detector_panel_1
        .translate_from_nxlog("stageZ", [0,0,1], "f144", "nmx_robot", "NMX:Robot1:stageZ", units="m", offset=[-0.8, -0.7, -0.7], offset_units="m")
        .rotate_from_nxlog("axis1", [0,1,0], "f144", "nmx_robot", "NMX:Robot1:axis1", units="m", offset=[0, 0.1, 0], offset_units="m")
        .rotate_from_nxlog("axis2", [0,0,1], "f144", "nmx_robot", "NMX:Robot1:axis2", units="m", offset=[0.22, 0, 0], offset_units="m")
        .rotate_from_nxlog("axis3", [0,0,1], "f144", "nmx_robot", "NMX:Robot1:axis3", units="m", offset=[0, 0.4, 0], offset_units="m")
        .rotate_from_nxlog("axis4", [1,0,0], "f144", "nmx_robot", "NMX:Robot1:axis4", units="m", offset=[0.05, 0.12, 0.06], offset_units="m")
        .rotate_from_nxlog("axis5", [0,0,1], "f144", "nmx_robot", "NMX:Robot1:axis5", units="m", offset=[0.3, 0, 0], offset_units="m")
        .rotate_from_nxlog("axis6", [1,0,0], "f144", "nmx_robot", "NMX:Robot1:axis6", units="m", offset=[0.15, 0, 0], offset_units="m")
        .rotate("orientation", y=90)
    )
    ...
    (
        detector_panel_2
        .translate_from_nxlog("stageZ", [0,0,1], "f144", "nmx_robot", "NMX:Robot2:stageZ", units="m", offset=[0.8, -0.7, -0.6], offset_units="m")
        .rotate("arm_chair", y=180)
        .rotate_from_nxlog("axis1", [0,1,0], "f144", "nmx_robot", "NMX:Robot2:axis1", units="m", offset=[0, 0.1, 0], offset_units="m")
        .rotate_from_nxlog("axis2", [0,0,1], "f144", "nmx_robot", "NMX:Robot2:axis2", units="m", offset=[0.22, 0, 0], offset_units="m")
        .rotate_from_nxlog("axis3", [0,0,1], "f144", "nmx_robot", "NMX:Robot2:axis3", units="m", offset=[0, 0.4, 0], offset_units="m")
        .rotate_from_nxlog("axis4", [1,0,0], "f144", "nmx_robot", "NMX:Robot2:axis4", units="m", offset=[0.05, 0.12, 0.06], offset_units="m")
        .rotate_from_nxlog("axis5", [0,0,1], "f144", "nmx_robot", "NMX:Robot2:axis5", units="m", offset=[0.3, 0, 0], offset_units="m")
        .rotate_from_nxlog("axis6", [1,0,0], "f144", "nmx_robot", "NMX:Robot2:axis6", units="m", offset=[0.15, 0, 0], offset_units="m")
        .rotate("orientation", y=-90)
    )
    ...
    (
        sample
        .rotate_from_nxlog("axis1", [0,1,0], "f144", "nmx_robot", "NMX:SampleRobot:axis1", units="m", offset=[0, -1.082, 0], offset_units="m")
        .rotate_from_nxlog("axis2", [1,0,0], "f144", "nmx_robot", "NMX:SampleRobot:axis2", units="m", offset=[0.148, 0.232, 0], offset_units="m")
        .rotate_from_nxlog("axis3", [1,0,0], "f144", "nmx_robot", "NMX:SampleRobot:axis3", units="m", offset=[0, 0.425, 0], offset_units="m")
        .rotate_from_nxlog("axis4", [0,1,0], "f144", "nmx_robot", "NMX:SampleRobot:axis4", units="m", offset=[-0.1105, 0.2, 0], offset_units="m")
        .rotate_from_nxlog("axis5", [1,0,0], "f144", "nmx_robot", "NMX:SampleRobot:axis5", units="m", offset=[0, 0.125, 0], offset_units="m")
        .rotate_from_nxlog("axis6", [0,1,0], "f144", "nmx_robot", "NMX:SampleRobot:axis6", units="m", offset=[0, 0.1, 0], offset_units="m")
    )
